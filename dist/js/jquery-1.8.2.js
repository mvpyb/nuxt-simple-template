 ...
 */
  ...
  jQuery.support = ( function() {
    ...
    jQuery( function() {
      var container; var div; var tds; var marginDiv
  ...
  jQuery.fn.extend( {
    data : function( key, value ) {
      var parts; var part; var attr; var name; var l
      var elem = this[0]
      var i = 0
      var data = null
  ...
  var nodeHook; var boolHook; var fixSpecified
  var rclass = /[\t\r\n]/g
  var rreturn = /\r/g
  ...
  jQuery.extend( {
    valHooks : {
      ...
      select : {
        get : function( elem ) {
          var value; var i; var max; var option
    ...
    removeAttr : function( elem, value ) {
      var propName; var attrNames; var name; var isBool
      var i = 0
 ...
 */
  jQuery.event = {
    ...
    remove : function( elem, types, handler, selector, mappedTypes ) {
      var t; var tns; var type; var origType; var namespaces; var origCount
      var j; var events; var special; var eventType; var handleObj
    ...
    trigger : function( event, data, elem, onlyHandlers ) {
      ...
      var cache; var exclusive; var i; var cur; var old; var ontype; var special; var handle; var eventPath; var bubbleType
    ...
    dispatch : function( event ) {
      ...
      var i; var j; var cur; var ret; var selMatch; var matched; var matches; var handleObj; var sel; var related
 ...
 */
  ( function( window, undefined ) {
    ...
    var pseudos = ':(' + characterEncoding + ")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:" + attributes + ')|[^:]|\\\\.)*|.*))\\)|)'

    // For matchExpr.POS and matchExpr.needsContext
    var pos = ':(even|odd|eq|gt|lt|nth|first|last)(?:\\(' + whitespace +
		'*((?:-\\d)?\\d*)' + whitespace + '*\\)|)(?=[^-]|$)'
    ...
    var assertTagNameNoComments = assert( function( div ) {
      div.appendChild( document.createComment( '' ) )
      return !div.getElementsByTagName( '*' ).length
    } )

    // Check if getAttribute returns normalized href attributes
    var assertHrefNotNormalized = assert( function( div ) {
    ...
    var assertAttributes = assert( function( div ) {
    ...
    var assertUsableClassName = assert( function( div ) {
    ...
    var assertUsableName = assert( function( div ) {
      // Inject content
      div.id = expando + 0
    ...
    function Sizzle( selector, context, results, seed ) {
      results = results || []
      context = context || document
      var match; var elem; var xml; var m
 ...
 */
    ...
    function tokenize( selector, parseOnly ) {
      var matched; var match; var tokens; var type; var soFar; var groups; var preFilters
    ...
    function setMatcher( preFilter, selector, matcher, postFilter, postFinder, postSelector ) {
      ...
      return markFunction( function( seed, results, context, xml ) {
        ...
        var i; var elem; var postFilterIn
        var preMap = []
        var postMap = []
        var preexisting = results.length

        // Get initial elements from seed or context
        var elems = seed || multipleContexts( selector || '*', context.nodeType ? [context] : context, [], seed )
    ...
    if ( document.querySelectorAll ) {
      ( function() {
        ...
        var rbuggyMatches = [':active', ':focus']
  ...
  jQuery.fn.extend( {
    find : function( selector ) {
      var i; var l; var length; var n; var r; var ret
      var self = this
  ...
  jQuery.fn.extend( {
    ...
    replaceWith : function( value ) {
      if ( !isDisconnected( this[0] ) ) {
        ...
        if ( jQuery.isFunction( value ) ) {
          return this.each( function( i ) {
            var self = jQuery( this ); var old = self.html()
    ...
    domManip : function( args, table, callback ) {
      ...
      var results; var first; var fragment; var iNoClone
      var i = 0
      var value = args[0]
      var scripts = []
      var l = this.length
  ...
  jQuery.buildFragment = function( args, context, scripts ) {
    var fragment; var cacheable; var cachehit
    var first = args[ 0 ]
  ...
  jQuery.extend( {
    ...
    clean : function( elems, context, fragment, scripts ) {
      var i; var j; var elem; var tag; var wrap; var depth; var div; var hasBody; var tbody; var len; var handleScript; var jsTags
  ...
  var curCSS; var iframe; var iframeDoc
  var ralpha = /alpha\([^)]*\)/i
  ...
  if ( window.getComputedStyle ) {
    curCSS = function( elem, name ) {
      var ret; var width; var minWidth; var maxWidth
  ...
  function addToPrefiltersOrTransports( structure ) {
    ...
    return function( dataTypeExpression, func ) {
      ...
      var dataType; var list; var placeBefore
  ...
  jQuery.extend( {
    ...
    ajax : function( url, options ) {
      ...
      var globalEventContext = callbackContext !== s &&
 ...
 */
  ...
  function defaultPrefilter( elem, props, opts ) {
    var index; var prop; var value; var length; var dataShow; var tween; var hooks; var oldfire
    var anim = this
    var style = elem.style
    var orig = {}
    var handled = []
  ...
  jQuery.fn.offset = function( options ) {
    ...
    var docElem; var body; var win; var clientTop; var clientLeft; var scrollTop; var scrollLeft
